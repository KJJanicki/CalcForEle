...
std::string ZamianaTest::decimalToBinary(std::string decimalNum) {
...
std::string ZamianaTest::decimalToOctal(std::string decimalNum) {
    int integerNum = std::stoi(decimalNum);     //zamiana string na int
    std::string octalNum = "";
    if (integerNum == 0) {
        octalNum = "0";
...
std::string ZamianaTest::decimalToHexadecimal(std::string decimalNum) {
    int integerNum = std::stoi(decimalNum);     //zamiana string na int
    std::string hexNum = "";
    if (integerNum == 0) {
        hexNum = "0";
...
std::string ZamianaTest::hexadecimalToDecimal(const std::string& hexNum) {
    int decimalValue = 0;
...
std::string ZamianaTest::octalToDecimal(const std::string& octalNum) {
    int decimalValue = 0;
...
std::string ZamianaTest::binaryToDecimal(const std::string& binaryNum) {
    int decimalValue = 0;
...
bool ZamianaTest::isValidDecimal(const std::string& decimalStr) {
...
bool ZamianaTest::isValidBinary(const std::string& binaryStr) {
...
bool ZamianaTest::isValidOctal(const std::string& octalStr) {
...
bool ZamianaTest::isValidHexadecimal(const std::string& hexStr) {
